...
class MainActivity : AppCompatActivity(), OnConfigChangeListener {
    ...
    private fun showConfigError(errorMessage: String) {
        ...
        errorText.appendLine("settings-theme: free-dark|free-light")
        errorText.appendLine("settings-interface-shift-x: <number>")
        errorText.appendLine("settings-interface-shift-y: <number>")
        errorText.appendLine("settings-active-tab: store|applications|interface|vehicle|settings")
        errorText.appendLine("vehicle-fuel-mode: electric|electric_forced|hybrid|save")
        errorText.appendLine("vehicle-drive-mode: eco|comfort|sport|snow|outing|individual")
        errorText.appendLine("interface-keyboard: <string>")
        errorText.appendLine("interface-widget-weather: <string>")
        errorText.appendLine("settings-startup: off|hidden|interface")
        errorText.appendLine("settings-car-model: free|dreamer")
        errorText.appendLine("vehicle-pedestrian-warning: original|off")
